...
public class FileScanner implements Scan {
    ...
    private static class ClassSearcher {
        ...
        private Set<Class<?>> doPath(File file, String packageName, Predicate<Class<?>> predicate, boolean flag) throws ScannerClassException {
    ...
    @Override
    public Set<Class<?>> search(String packageName, Predicate<Class<?>> predicate) throws ScannerClassException {
